...
namespace NewLib.Data.Mongodb.Driver
{
    ...
    public abstract class MapReduceOutputOptions
    {
        ...
        public static MapReduceOutputOptions Merge(string collectionName, string databaseName = null, bool? sharded = null, bool? nonAtomic = null)
        {
            ...
            return new CollectionOutput(collectionName, Core.Core.Operations.MapReduceOutputMode.Merge, databaseName, sharded, nonAtomic);
        }
        ...
        {
            Ensure.IsNotNull(collectionName, nameof(collectionName));
            return new CollectionOutput(collectionName, Core.Core.Operations.MapReduceOutputMode.Reduce, databaseName, sharded, nonAtomic);
        }
        ...
        {
            Ensure.IsNotNull(collectionName, nameof(collectionName));
            return new CollectionOutput(collectionName, Core.Core.Operations.MapReduceOutputMode.Replace, databaseName, sharded, null);
        }
        ...
        internal sealed class CollectionOutput : MapReduceOutputOptions
        {
            ...
            private readonly Core.Core.Operations.MapReduceOutputMode _outputMode;
            private readonly bool? _sharded;

            internal CollectionOutput(string collectionName, Core.Core.Operations.MapReduceOutputMode outputMode, string databaseName = null, bool? sharded = null, bool? nonAtomic = null)
            {
            ...
            public Core.Core.Operations.MapReduceOutputMode OutputMode
            {
