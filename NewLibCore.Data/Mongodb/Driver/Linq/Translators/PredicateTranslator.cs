...
namespace NewLib.Data.Mongodb.Driver.Linq.Translators
{
    internal sealed class PredicateTranslator
    {
        ...
        public static BsonDocument Translate<TDocument>(Expression<Func<TDocument, bool>> predicate, IBsonSerializer parameterSerializer, IBsonSerializerRegistry serializerRegistry)
        {
