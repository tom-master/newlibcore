...
namespace NewLibCore.Data.Mongodb.Driver.Linq.Translators
{
    internal static class AggregateGroupTranslator
    {
        ...
        private static Expression BindKeySelector<TKey, TDocument>(PipelineBindingContext bindingContext, Expression<Func<TDocument, TKey>> keySelector, IBsonSerializer parameterSerializer)
        {
