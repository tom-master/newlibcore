...
namespace NewLibCore.Data.Mongodb.Driver.GeoJsonObjectModel.Serializers
{
    ...
    public class GeoJsonFeatureSerializer<TCoordinates> : ClassSerializerBase<GeoJsonFeature<TCoordinates>> where TCoordinates : GeoJsonCoordinates
    {
        ...
        // private fields
        private readonly Bson.Serialization.IBsonSerializer<GeoJsonGeometry<TCoordinates>> _geometrySerializer = BsonSerializer.LookupSerializer<GeoJsonGeometry<TCoordinates>>();
