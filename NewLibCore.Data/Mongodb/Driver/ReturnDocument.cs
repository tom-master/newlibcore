...
namespace NewLibCore.Data.Mongodb.Driver
{
    ...
    {
        public static Core.Core.Operations.ReturnDocument ToCore(this ReturnDocument returnDocument)
        {
            switch (returnDocument)
            {
                case ReturnDocument.Before:
                    return Core.Core.Operations.ReturnDocument.Before;
                case ReturnDocument.After:
                    return Core.Core.Operations.ReturnDocument.After;
                default:
