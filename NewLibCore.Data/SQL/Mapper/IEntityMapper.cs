...
namespace NewLibCore.Data.SQL.Mapper
{
    ...
    public interface ISelectEntityMapper<TModel> where TModel : EntityBase, new()
    {
        ...
        ISelectEntityMapper<TModel> LeftJoin<TRight>(Expression<Func<TModel, TRight, Boolean>> expression) where TRight : PropertyMonitor, new();

        ISelectEntityMapper<TModel> RightJoin<TRight>(Expression<Func<TModel, TRight, Boolean>> expression) where TRight : PropertyMonitor, new();

        ISelectEntityMapper<TModel> InnerJoin<TRight>(Expression<Func<TModel, TRight, Boolean>> expression) where TRight : PropertyMonitor, new();

        ISelectEntityMapper<TModel> OrderBy<TOrder, TKey>(Expression<Func<TOrder, TKey>> order, OrderByType orderBy = OrderByType.DESC) where TOrder : PropertyMonitor, new();
    }
    ...
    public class SelectEntityMapper<TModel> : ISelectEntityMapper<TModel> where TModel : EntityBase, new()
    {
        ...
        {
            IBuilder<TModel> builder = new SelectBuilder<TModel>(_instance.StatementStore, fields, pageIndex, pageSize);
            ...
            _instance.StatementStore.Clear();
        ...
        public ISelectEntityMapper<TModel> Select(Expression<Func<TModel, dynamic>> fields = null)
        {
            if (fields != null)
            {
                _instance.StatementStore.AddSelectFields(fields);
            }
            return default;
        }
        ...
        public ISelectEntityMapper<TModel> LeftJoin<TRight>(Expression<Func<TModel, TRight, Boolean>> expression) where TRight : PropertyMonitor, new()
        {
        ...
        public ISelectEntityMapper<TModel> RightJoin<TRight>(Expression<Func<TModel, TRight, Boolean>> expression) where TRight : PropertyMonitor, new()
        {
            Parameter.Validate(expression);
        ...
        public ISelectEntityMapper<TModel> InnerJoin<TRight>(Expression<Func<TModel, TRight, Boolean>> expression) where TRight : PropertyMonitor, new()
        {
            Parameter.Validate(expression);
        ...
        public ISelectEntityMapper<TModel> OrderBy<TOrder, TKey>(Expression<Func<TOrder, TKey>> order, OrderByType orderBy = OrderByType.DESC) where TOrder : PropertyMonitor, new()
        {
