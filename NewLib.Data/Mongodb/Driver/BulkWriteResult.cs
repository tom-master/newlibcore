...
namespace NewLib.Data.Mongodb.Driver
{
    ...
    public abstract class BulkWriteResult<TDocument> : BulkWriteResult
    {
        ...
        internal static BulkWriteResult<TDocument> FromCore(Core.Core.Operations.BulkWriteOperationResult result)
        {
        ...
        internal static BulkWriteResult<TDocument> FromCore(Core.Core.Operations.BulkWriteOperationResult result, IEnumerable<WriteModel<TDocument>> requests)
        {
            if (result.IsAcknowledged)
            {
                return new Acknowledged(
